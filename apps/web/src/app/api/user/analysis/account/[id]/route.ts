...
import { AccountAnalysis, User, UserAnalysisRecord } from "@hotornot/database";
...
export async function GET(
  ...
  try {
    console.log("🔍 获取账号分析详情:", params.id);
    ...
    // 然后查找对应的分析结果
    const analysis = await AccountAnalysis.findOne({
    ...
    console.log("✅ 找到账号分析记录:", analysis._id);
    ...
    console.error("❌ 获取账号分析详情失败:", error);
    return NextResponse.json(
